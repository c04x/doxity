...
exports.default = function (src) {
  ...
  return new Promise(function (resolve) {
    var isTruffleProject = _fs2.default.existsSync(process.cwd() + '/truffle.js') || _fs2.default.existsSync(process.cwd() + '/truffle-config.js');
    ...
    if (isTruffleProject) {
      ...
      resolve({
        contracts: Object.keys(res.contracts).reduce(function (o, k) {
          ...
          var fileName = process.cwd() + '/' + k.split(':')[0];
